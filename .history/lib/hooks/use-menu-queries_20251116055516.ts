...
export function useGetMenus(): UseQueryResult<MenuItem[], AxiosError> {
  return useQuery({
    queryKey: menuQueryKeys.list(),
    queryFn: async () => {
      const response = await axiosInstance.get<MenuItem[]>('/menu/all-menus')
...
export function useAdminGetMenus(): UseQueryResult<MenuItem[], AxiosError> {
  return useQuery({
    queryKey: [...menuQueryKeys.lists(), 'admin'],
    queryFn: async () => {
      const response = await axiosInstance.get<MenuItem[]>('/menu/all')
      return response.data
    },
...
export function useGetMenu(id: string): UseQueryResult<MenuItem, AxiosError> {
  return useQuery({
