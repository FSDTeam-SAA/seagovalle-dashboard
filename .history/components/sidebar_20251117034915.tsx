...
export function Sidebar() {
  ...
  return (
    <>
      ...
      `}>
        <div className="p-6">
         <Image src="/white-logo.svg" alt="Logo" width={150} height={40} className="mb-10" />
                ...
                <Link key={item.href} href={item.href} className='cusor-pointer'>
                  <button
                    ...
                    className={`
                      ...
                      transition-colors
                      ${isActive
                        ? 'bg-[#343A40] text-sidebar-primary-foreground'
          ...
          <div className="border-t border-sidebar-border mt-8 pt-8">
            <Button
              variant="ghost"
              className="w-full justify-start gap-3 text-red-500 hover:text-sidebar-accent "
            >
              <LogOut size={20} />
              Log Out
            </Button>
