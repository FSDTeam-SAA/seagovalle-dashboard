  ...
  return (
    <div className="flex items-center justify-center  ">
      <div className="w-full">
        {/* Header */}
        <h2 className="text-3xl md:text-[40px] font-playfair font-bold text-primary mb-2">
          Change Password
        </h2>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-primary hover:bg-red-800 text-white font-semibold rounded-md cursor-pointer"
            >
