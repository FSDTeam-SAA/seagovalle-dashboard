...
export default function Login() {
  ...
  return (
    <div className="w-full max-w-7xl border p-8 rounded-lg shadow-lg bg-white">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <a
              ...
              className="text-primary text-sm border-b border-gray-400 cursor-pointer"
            >
              Forgot password?
            </a>
          </div>
          ...
          <Button
            type="submit"
            className="w-full h-10 bg-primary hover:bg-[##ff2b2b] cursor-pointer"
            disabled={isLoading}
          >
