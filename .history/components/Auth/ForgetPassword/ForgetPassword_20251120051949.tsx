...
export default function ForgetPassword() {
  ...
  return (
    <div className="w-full max-w-lg">
      <h2 className="text-3xl md:text-[48px] font-bold leading-[150%] font-playfair text-primary mb-2">
        Forgot Password
      </h2>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full h-10 bg-primary hover:bg-red-800 cursor-pointer"
          >
            Send OTP
          </Button>
        </form>
