...
import { ReviewAnalyticsWidget, RatingBreakdown } from '@/components/reviews/review-analytics'
import {
...
export function ReviewsPageContent() {
  ...
  const { data: analyticsData, isLoading: analyticsLoading } = useGetReviewsAnalytics()
  const { data: reviewsData, isLoading: reviewsLoading } = useGetAllReviewsAdmin({
    ...filters,
    page: currentPage,
  })
